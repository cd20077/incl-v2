...
class GroupTableMap extends TableMap
{
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('File', 'File', RelationMap::ONE_TO_MANY, array('id' => 'group_id', ), null, null, 'Files');
        $this->addRelation('GroupMember', 'GroupMember', RelationMap::ONE_TO_MANY, array('id' => 'group_id', ), null, null, 'GroupMembers');
        $this->addRelation('UserLog', 'UserLog', RelationMap::ONE_TO_MANY, array('id' => 'group_id', ), null, null, 'UserLogs');
    } // buildRelations()
