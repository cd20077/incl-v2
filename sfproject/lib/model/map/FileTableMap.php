...
class FileTableMap extends TableMap
{
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('FileRelatedByParentDirectoryId', 'File', RelationMap::MANY_TO_ONE, array('parent_directory_id' => 'id', ), null, null);
        $this->addRelation('FileRelatedById', 'File', RelationMap::ONE_TO_MANY, array('id' => 'parent_directory_id', ), null, null, 'FilesRelatedById');
    } // buildRelations()
