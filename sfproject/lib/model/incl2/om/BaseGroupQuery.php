 ...
 * @method GroupQuery orderByAccountId($order = Criteria::ASC) Order by the account_id column
 *
 ...
 * @method GroupQuery groupByAccountId() Group by the account_id column
 *
 ...
 *
 * @method GroupQuery leftJoinAccount($relationAlias = null) Adds a LEFT JOIN clause to the query using the Account relation
 * @method GroupQuery rightJoinAccount($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Account relation
 * @method GroupQuery innerJoinAccount($relationAlias = null) Adds a INNER JOIN clause to the query using the Account relation
 *
 * @method GroupQuery leftJoinAccountLog($relationAlias = null) Adds a LEFT JOIN clause to the query using the AccountLog relation
 * @method GroupQuery rightJoinAccountLog($relationAlias = null) Adds a RIGHT JOIN clause to the query using the AccountLog relation
 * @method GroupQuery innerJoinAccountLog($relationAlias = null) Adds a INNER JOIN clause to the query using the AccountLog relation
 *
 ...
 * @method Group findOneByAccountId(int $account_id) Return the first Group filtered by the account_id column
 *
 ...
 * @method array findByAccountId(int $account_id) Return Group objects filtered by the account_id column
 *
...
abstract class BaseGroupQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT "id", "is_deleted", "updated_at", "deleted_at", "created_at", "name", "maxcapa", "precapa", "backimg", "ranid", "account_id" FROM "group" WHERE "id" = :p0';
        try {
    ...
    public function filterByAccountId($accountId = null, $comparison = null)
    {
        if (is_array($accountId)) {
            ...
            if (isset($accountId['min'])) {
                $this->addUsingAlias(GroupPeer::ACCOUNT_ID, $accountId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($accountId['max'])) {
                $this->addUsingAlias(GroupPeer::ACCOUNT_ID, $accountId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(GroupPeer::ACCOUNT_ID, $accountId, $comparison);
    }
    ...
    public function filterByAccount($account, $comparison = null)
    {
        if ($account instanceof Account) {
            return $this
                ->addUsingAlias(GroupPeer::ACCOUNT_ID, $account->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(GroupPeer::ACCOUNT_ID, $account->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByAccountLog($accountLog, $comparison = null)
    {
        if ($accountLog instanceof AccountLog) {
            return $this
                ->addUsingAlias(GroupPeer::ID, $accountLog->getGroupId(), $comparison);
