...
abstract class BaseGroup extends BaseObject implements Persistent
{
    ...
    public function setIsDeleted($v)
    {
        ...
        if ($this->is_deleted !== $v) {
            $this->is_deleted = $v;
            $this->modifiedColumns[] = GroupPeer::IS_DELETED;
        }
    ...
    public function setDeletedAt($v)
    {
        ...
        if ($this->deleted_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = GroupPeer::DELETED_AT;
            }
        } // if either are not null
    ...
    public function setMaxcapa($v)
    {
        ...
        if ($this->maxcapa !== $v) {
            $this->maxcapa = $v;
            $this->modifiedColumns[] = GroupPeer::MAXCAPA;
        }
    ...
    public function setPrecapa($v)
    {
        ...
        if ($this->precapa !== $v) {
            $this->precapa = $v;
            $this->modifiedColumns[] = GroupPeer::PRECAPA;
        }
    ...
    public function setBackimg($v)
    {
        ...
        if ($this->backimg !== $v) {
            $this->backimg = $v;
            $this->modifiedColumns[] = GroupPeer::BACKIMG;
        }
    ...
    public function setRanid($v)
    {
        ...
        if ($this->ranid !== $v) {
            $this->ranid = $v;
            $this->modifiedColumns[] = GroupPeer::RANID;
        }
    ...
    public function setAccountId($v)
    {
        ...
        if ($this->account_id !== $v) {
            $this->account_id = $v;
            $this->modifiedColumns[] = GroupPeer::ACCOUNT_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 11; // 11 = GroupPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if (null === $this->id) {
            try {
                $stmt = $con->query("SELECT nextval('group_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(GroupPeer::IS_DELETED)) {
            $modifiedColumns[':p' . $index++]  = '"is_deleted"';
        }
        if ($this->isColumnModified(GroupPeer::UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '"updated_at"';
        }
        if ($this->isColumnModified(GroupPeer::DELETED_AT)) {
        ...
        if ($this->isColumnModified(GroupPeer::MAXCAPA)) {
            $modifiedColumns[':p' . $index++]  = '"maxcapa"';
        }
        if ($this->isColumnModified(GroupPeer::PRECAPA)) {
            $modifiedColumns[':p' . $index++]  = '"precapa"';
        }
        if ($this->isColumnModified(GroupPeer::BACKIMG)) {
            $modifiedColumns[':p' . $index++]  = '"backimg"';
        }
        if ($this->isColumnModified(GroupPeer::RANID)) {
            $modifiedColumns[':p' . $index++]  = '"ranid"';
        }
        if ($this->isColumnModified(GroupPeer::ACCOUNT_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GroupPeer::IS_DELETED)) $criteria->add(GroupPeer::IS_DELETED, $this->is_deleted);
        if ($this->isColumnModified(GroupPeer::UPDATED_AT)) $criteria->add(GroupPeer::UPDATED_AT, $this->updated_at);
        if ($this->isColumnModified(GroupPeer::DELETED_AT)) $criteria->add(GroupPeer::DELETED_AT, $this->deleted_at);
        ...
        if ($this->isColumnModified(GroupPeer::MAXCAPA)) $criteria->add(GroupPeer::MAXCAPA, $this->maxcapa);
        if ($this->isColumnModified(GroupPeer::PRECAPA)) $criteria->add(GroupPeer::PRECAPA, $this->precapa);
        if ($this->isColumnModified(GroupPeer::BACKIMG)) $criteria->add(GroupPeer::BACKIMG, $this->backimg);
        if ($this->isColumnModified(GroupPeer::RANID)) $criteria->add(GroupPeer::RANID, $this->ranid);
        if ($this->isColumnModified(GroupPeer::ACCOUNT_ID)) $criteria->add(GroupPeer::ACCOUNT_ID, $this->account_id);
    ...
    public function setAccountLogs(PropelCollection $accountLogs, PropelPDO $con = null)
    {
        ...
        foreach ($accountLogsToDelete as $accountLogRemoved) {
            $accountLogRemoved->setGroup(null);
        }
     ...
     * @return PropelObjectCollection|File[] List of File objects
     */
    public function getFilesJoinAccount($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = FileQuery::create(null, $criteria);
        $query->joinWith('Account', $join_behavior);
     ...
     * @return PropelObjectCollection|File[] List of File objects
     */
    public function getFilesJoinFileStatus($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = FileQuery::create(null, $criteria);
    ...
    public function setGroupMembers(PropelCollection $groupMembers, PropelPDO $con = null)
    {
        ...
        foreach ($groupMembersToDelete as $groupMemberRemoved) {
            $groupMemberRemoved->setGroup(null);
        }
     ...
     * @return PropelObjectCollection|GroupMember[] List of GroupMember objects
     */
    public function getGroupMembersJoinAccount($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = GroupMemberQuery::create(null, $criteria);
        $query->joinWith('Account', $join_behavior);
