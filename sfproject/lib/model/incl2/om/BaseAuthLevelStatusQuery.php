 ...
 *
 * @method AuthLevelStatusQuery leftJoinGroupMember($relationAlias = null) Adds a LEFT JOIN clause to the query using the GroupMember relation
 * @method AuthLevelStatusQuery rightJoinGroupMember($relationAlias = null) Adds a RIGHT JOIN clause to the query using the GroupMember relation
 * @method AuthLevelStatusQuery innerJoinGroupMember($relationAlias = null) Adds a INNER JOIN clause to the query using the GroupMember relation
 *
...
abstract class BaseAuthLevelStatusQuery extends ModelCriteria
{
    ...
    public function filterByGroupMember($groupMember, $comparison = null)
    {
        if ($groupMember instanceof GroupMember) {
            return $this
                ->addUsingAlias(AuthLevelStatusPeer::ID, $groupMember->getAuthLevelStatusId(), $comparison);
