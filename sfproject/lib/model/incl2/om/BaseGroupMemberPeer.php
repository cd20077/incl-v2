...
abstract class BaseGroupMemberPeer
{
    ...
    const ACCOUNT_ID = 'group_member.account_id';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'IsDeleted', 'UpdatedAt', 'DeletedAt', 'CreatedAt', 'AccountId', 'GroupId', 'AuthLevelStatusId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'isDeleted', 'updatedAt', 'deletedAt', 'createdAt', 'accountId', 'groupId', 'authLevelStatusId', ),
        BasePeer::TYPE_COLNAME => array (GroupMemberPeer::ID, GroupMemberPeer::IS_DELETED, GroupMemberPeer::UPDATED_AT, GroupMemberPeer::DELETED_AT, GroupMemberPeer::CREATED_AT, GroupMemberPeer::ACCOUNT_ID, GroupMemberPeer::GROUP_ID, GroupMemberPeer::AUTH_LEVEL_STATUS_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'IS_DELETED', 'UPDATED_AT', 'DELETED_AT', 'CREATED_AT', 'ACCOUNT_ID', 'GROUP_ID', 'AUTH_LEVEL_STATUS_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'is_deleted', 'updated_at', 'deleted_at', 'created_at', 'account_id', 'group_id', 'auth_level_status_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'IsDeleted' => 1, 'UpdatedAt' => 2, 'DeletedAt' => 3, 'CreatedAt' => 4, 'AccountId' => 5, 'GroupId' => 6, 'AuthLevelStatusId' => 7, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'isDeleted' => 1, 'updatedAt' => 2, 'deletedAt' => 3, 'createdAt' => 4, 'accountId' => 5, 'groupId' => 6, 'authLevelStatusId' => 7, ),
        BasePeer::TYPE_COLNAME => array (GroupMemberPeer::ID => 0, GroupMemberPeer::IS_DELETED => 1, GroupMemberPeer::UPDATED_AT => 2, GroupMemberPeer::DELETED_AT => 3, GroupMemberPeer::CREATED_AT => 4, GroupMemberPeer::ACCOUNT_ID => 5, GroupMemberPeer::GROUP_ID => 6, GroupMemberPeer::AUTH_LEVEL_STATUS_ID => 7, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'IS_DELETED' => 1, 'UPDATED_AT' => 2, 'DELETED_AT' => 3, 'CREATED_AT' => 4, 'ACCOUNT_ID' => 5, 'GROUP_ID' => 6, 'AUTH_LEVEL_STATUS_ID' => 7, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'is_deleted' => 1, 'updated_at' => 2, 'deleted_at' => 3, 'created_at' => 4, 'account_id' => 5, 'group_id' => 6, 'auth_level_status_id' => 7, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(GroupMemberPeer::ACCOUNT_ID);
    ...
    public static function doCountJoinAccount(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(GroupMemberPeer::ACCOUNT_ID, AccountPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of GroupMember objects pre-filled with their Account objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAccount(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (GroupMember) to $obj2 (Account)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (GroupMember) to the collection in $obj2 (Account)
                $obj2->addGroupMember($obj1);
    ...
    /**
     * Selects a collection of GroupMember objects pre-filled with all related objects except Account.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
