...
abstract class BaseGroupPeer
{
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (GroupPeer::ID, GroupPeer::IS_DELETED, GroupPeer::UPDATED_AT, GroupPeer::DELETED_AT, GroupPeer::CREATED_AT, GroupPeer::NAME, GroupPeer::MAXCAPA, GroupPeer::PRECAPA, GroupPeer::BACKIMG, GroupPeer::RANID, GroupPeer::ACCOUNT_ID, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (GroupPeer::ID => 0, GroupPeer::IS_DELETED => 1, GroupPeer::UPDATED_AT => 2, GroupPeer::DELETED_AT => 3, GroupPeer::CREATED_AT => 4, GroupPeer::NAME => 5, GroupPeer::MAXCAPA => 6, GroupPeer::PRECAPA => 7, GroupPeer::BACKIMG => 8, GroupPeer::RANID => 9, GroupPeer::ACCOUNT_ID => 10, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(GroupPeer::ACCOUNT_ID);
        } else {
    ...
    public static function doCountJoinAccount(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(GroupPeer::ACCOUNT_ID, AccountPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Group objects pre-filled with their Account objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAccount(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Group) to $obj2 (Account)
                $obj2->addGroup($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Group) to the collection in $obj2 (Account)
                $obj2->addGroup($obj1);
