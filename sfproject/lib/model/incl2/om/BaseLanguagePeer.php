...
abstract class BaseLanguagePeer
{
    ...
    const IS_DELETED = 'language.is_deleted';

    /** the column name for the updated_at field */
    const UPDATED_AT = 'language.updated_at';

    /** the column name for the deleted_at field */
    const DELETED_AT = 'language.deleted_at';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (LanguagePeer::ID, LanguagePeer::IS_DELETED, LanguagePeer::UPDATED_AT, LanguagePeer::DELETED_AT, LanguagePeer::CREATED_AT, LanguagePeer::NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (LanguagePeer::ID => 0, LanguagePeer::IS_DELETED => 1, LanguagePeer::UPDATED_AT => 2, LanguagePeer::DELETED_AT => 3, LanguagePeer::CREATED_AT => 4, LanguagePeer::NAME => 5, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(LanguagePeer::IS_DELETED);
            $criteria->addSelectColumn(LanguagePeer::UPDATED_AT);
            $criteria->addSelectColumn(LanguagePeer::DELETED_AT);
