 ...
 * @method FileQuery orderByAccountId($order = Criteria::ASC) Order by the account_id column
 ...
 * @method FileQuery groupByAccountId() Group by the account_id column
 ...
 *
 * @method FileQuery leftJoinAccount($relationAlias = null) Adds a LEFT JOIN clause to the query using the Account relation
 * @method FileQuery rightJoinAccount($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Account relation
 * @method FileQuery innerJoinAccount($relationAlias = null) Adds a INNER JOIN clause to the query using the Account relation
 *
 ...
 * @method File findOneByAccountId(int $account_id) Return the first File filtered by the account_id column
 ...
 * @method array findByAccountId(int $account_id) Return File objects filtered by the account_id column
...
abstract class BaseFileQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT "id", "is_deleted", "is_directory", "updated_at", "deleted_at", "created_at", "origin_name", "encrypt_name", "size", "account_id", "group_id", "file_type", "parent_directory_id", "file_status_id" FROM "file" WHERE "id" = :p0';
        try {
    ...
    public function filterByAccountId($accountId = null, $comparison = null)
    {
        if (is_array($accountId)) {
            ...
            if (isset($accountId['min'])) {
                $this->addUsingAlias(FilePeer::ACCOUNT_ID, $accountId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($accountId['max'])) {
                $this->addUsingAlias(FilePeer::ACCOUNT_ID, $accountId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(FilePeer::ACCOUNT_ID, $accountId, $comparison);
    }
    ...
    public function filterByAccount($account, $comparison = null)
    {
        if ($account instanceof Account) {
            return $this
                ->addUsingAlias(FilePeer::ACCOUNT_ID, $account->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(FilePeer::ACCOUNT_ID, $account->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
