...
class AccountTableMap extends TableMap
{
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('File', 'File', RelationMap::ONE_TO_MANY, array('id' => 'account_id', ), 'RESTRICT', 'RESTRICT', 'Files');
        $this->addRelation('Group', 'Group', RelationMap::ONE_TO_MANY, array('id' => 'account_id', ), 'RESTRICT', 'RESTRICT', 'Groups');
        $this->addRelation('GroupMember', 'GroupMember', RelationMap::ONE_TO_MANY, array('id' => 'account_id', ), 'RESTRICT', 'RESTRICT', 'GroupMembers');
    } // buildRelations()
