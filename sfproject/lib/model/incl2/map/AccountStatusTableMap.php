...
class AccountStatusTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'lib.model.incl2.map.AccountStatusTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('AccountStatus');
    ...
    {
        $this->addRelation('Account', 'Account', RelationMap::ONE_TO_MANY, array('id' => 'account_status_id', ), 'RESTRICT', 'RESTRICT', 'Accounts');
    } // buildRelations()
