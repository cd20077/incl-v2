...
abstract class BaseUserLog extends BaseObject implements Persistent
{
    ...
    /**
     * Initializes internal state of BaseUserLog object.
     * @see        applyDefaults()
     */
     ...
     * @return UserLog The current object (for fluent API support)
     */
    ...
    public function setIsDeleted($v)
    {
        ...
        if ($this->is_deleted !== $v) {
            $this->is_deleted = $v;
            $this->modifiedColumns[] = UserLogPeer::IS_DELETED;
        }
    ...
    public function setDeletedAt($v)
    {
        ...
        if ($this->deleted_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = UserLogPeer::DELETED_AT;
            }
        } // if either are not null
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = UserLogPeer::TITLE;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = UserLogPeer::USER_ID;
        }
    ...
    public function setGroupId($v)
    {
        ...
        if ($this->group_id !== $v) {
            $this->group_id = $v;
            $this->modifiedColumns[] = UserLogPeer::GROUP_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 8; // 8 = UserLogPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = UserLogPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = UserLogQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseUserLog:delete:pre') as $callable)
            {
            ...
            if ($ret) {
                ...
                $this->postDelete($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseUserLog:delete:post') as $callable)
                {
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseUserLog:save:pre') as $callable)
            {
            ...
            if ($isInsert) {
                ...
                // symfony_timestampable behavior
                if (!$this->isColumnModified(UserLogPeer::CREATED_AT))
                {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseUserLog:save:post') as $callable)
                {
                  call_user_func($callable, $this, $con, $affectedRows);
                }

                UserLogPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if (null === $this->id) {
            try {
                $stmt = $con->query("SELECT nextval('user_log_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(UserLogPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '"id"';
        }
        if ($this->isColumnModified(UserLogPeer::IS_DELETED)) {
            $modifiedColumns[':p' . $index++]  = '"is_deleted"';
        }
        if ($this->isColumnModified(UserLogPeer::UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '"updated_at"';
        }
        if ($this->isColumnModified(UserLogPeer::DELETED_AT)) {
            $modifiedColumns[':p' . $index++]  = '"deleted_at"';
        }
        if ($this->isColumnModified(UserLogPeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '"created_at"';
        }
        if ($this->isColumnModified(UserLogPeer::TITLE)) {
            $modifiedColumns[':p' . $index++]  = '"title"';
        }
        if ($this->isColumnModified(UserLogPeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"user_id"';
        }
        if ($this->isColumnModified(UserLogPeer::GROUP_ID)) {
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $alreadyDumpedObjects['UserLog'][$this->getPrimaryKey()] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserLogPeer::IS_DELETED)) $criteria->add(UserLogPeer::IS_DELETED, $this->is_deleted);
        if ($this->isColumnModified(UserLogPeer::UPDATED_AT)) $criteria->add(UserLogPeer::UPDATED_AT, $this->updated_at);
        if ($this->isColumnModified(UserLogPeer::DELETED_AT)) $criteria->add(UserLogPeer::DELETED_AT, $this->deleted_at);
        if ($this->isColumnModified(UserLogPeer::CREATED_AT)) $criteria->add(UserLogPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(UserLogPeer::TITLE)) $criteria->add(UserLogPeer::TITLE, $this->title);
        if ($this->isColumnModified(UserLogPeer::USER_ID)) $criteria->add(UserLogPeer::USER_ID, $this->user_id);
        if ($this->isColumnModified(UserLogPeer::GROUP_ID)) $criteria->add(UserLogPeer::GROUP_ID, $this->group_id);
     ...
     * objects.
     *
     * @param object $copyObj An object of UserLog (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return UserLog Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(UserLogPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function __call($name, $params)
    {
        ...
        // symfony_behaviors behavior
        if ($callable = sfMixer::getCallable('BaseUserLog:' . $name))
        {
