...
abstract class BaseFile extends BaseObject implements Persistent
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->origin_name = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->encrypt_name = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            $this->size = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
            $this->user_id = ($row[$startcol + 8] !== null) ? (int) $row[$startcol + 8] : null;
            $this->group_id = ($row[$startcol + 9] !== null) ? (int) $row[$startcol + 9] : null;
            $this->file_type = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
            $this->parent_directory_id = ($row[$startcol + 11] !== null) ? (int) $row[$startcol + 11] : null;
            $this->resetModified();
            ...
            return $startcol + 12; // 12 = FilePeer::NUM_HYDRATE_COLUMNS.
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[5] => $this->getOriginName(),
            $keys[6] => $this->getEncryptName(),
            $keys[7] => $this->getSize(),
            $keys[8] => $this->getUserId(),
            $keys[9] => $this->getGroupId(),
            $keys[10] => $this->getFileType(),
            $keys[11] => $this->getParentDirectoryId(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[5], $arr)) $this->setOriginName($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setEncryptName($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setSize($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setUserId($arr[$keys[8]]);
        if (array_key_exists($keys[9], $arr)) $this->setGroupId($arr[$keys[9]]);
        if (array_key_exists($keys[10], $arr)) $this->setFileType($arr[$keys[10]]);
        if (array_key_exists($keys[11], $arr)) $this->setParentDirectoryId($arr[$keys[11]]);
    }
