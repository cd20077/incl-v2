...
abstract class BaseMail extends BaseObject implements Persistent
{
    ...
    /**
     * Initializes internal state of BaseMail object.
     * @see        applyDefaults()
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = MailPeer::ID;
        }
    ...
    public function setIsDeleted($v)
    {
        ...
        if ($this->is_deleted !== $v) {
            $this->is_deleted = $v;
            $this->modifiedColumns[] = MailPeer::IS_DELETED;
        }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = MailPeer::UPDATED_AT;
            }
    ...
    public function setDeletedAt($v)
    {
        ...
        if ($this->deleted_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = MailPeer::DELETED_AT;
            }
        } // if either are not null
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = MailPeer::CREATED_AT;
            }
        } // if either are not null
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = MailPeer::TITLE;
        }
    ...
    public function setText($v)
    {
        ...
        if ($this->text !== $v) {
            $this->text = $v;
            $this->modifiedColumns[] = MailPeer::TEXT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 7; // 7 = MailPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = MailQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseMail:delete:pre') as $callable)
            {
            ...
            if ($ret) {
                ...
                $this->postDelete($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseMail:delete:post') as $callable)
                {
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseMail:save:pre') as $callable)
            {
            ...
            if ($this->isModified() && !$this->isColumnModified(MailPeer::UPDATED_AT))
            {
            ...
            if ($isInsert) {
                ...
                // symfony_timestampable behavior
                if (!$this->isColumnModified(MailPeer::CREATED_AT))
                {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseMail:save:post') as $callable)
                {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if (null === $this->id) {
            try {
                $stmt = $con->query("SELECT nextval('mail_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(MailPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '"id"';
        }
        if ($this->isColumnModified(MailPeer::IS_DELETED)) {
            $modifiedColumns[':p' . $index++]  = '"is_deleted"';
        }
        if ($this->isColumnModified(MailPeer::UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '"updated_at"';
        }
        if ($this->isColumnModified(MailPeer::DELETED_AT)) {
            $modifiedColumns[':p' . $index++]  = '"deleted_at"';
        }
        if ($this->isColumnModified(MailPeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '"created_at"';
        }
        if ($this->isColumnModified(MailPeer::TITLE)) {
            $modifiedColumns[':p' . $index++]  = '"title"';
        }
        if ($this->isColumnModified(MailPeer::TEXT)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = MailPeer::doValidate($this, $columns)) !== true) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MailPeer::ID)) $criteria->add(MailPeer::ID, $this->id);
        if ($this->isColumnModified(MailPeer::IS_DELETED)) $criteria->add(MailPeer::IS_DELETED, $this->is_deleted);
        if ($this->isColumnModified(MailPeer::UPDATED_AT)) $criteria->add(MailPeer::UPDATED_AT, $this->updated_at);
        if ($this->isColumnModified(MailPeer::DELETED_AT)) $criteria->add(MailPeer::DELETED_AT, $this->deleted_at);
        if ($this->isColumnModified(MailPeer::CREATED_AT)) $criteria->add(MailPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(MailPeer::TITLE)) $criteria->add(MailPeer::TITLE, $this->title);
        if ($this->isColumnModified(MailPeer::TEXT)) $criteria->add(MailPeer::TEXT, $this->text);
    ...
    {
        $criteria = new Criteria(MailPeer::DATABASE_NAME);
        $criteria->add(MailPeer::ID, $this->id);
    ...
    public function __call($name, $params)
    {
        ...
        // symfony_behaviors behavior
        if ($callable = sfMixer::getCallable('BaseMail:' . $name))
        {
