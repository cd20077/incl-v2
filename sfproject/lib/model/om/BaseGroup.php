...
abstract class BaseGroup extends BaseObject implements Persistent
{
     ...
     * @return PropelObjectCollection|GroupMember[] List of GroupMember objects
     */
    public function getGroupMembersJoinUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = GroupMemberQuery::create(null, $criteria);
        $query->joinWith('User', $join_behavior);
     ...
     * @return PropelObjectCollection|UserLog[] List of UserLog objects
     */
    public function getUserLogsJoinUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = UserLogQuery::create(null, $criteria);
        $query->joinWith('User', $join_behavior);
