...
abstract class BaseSendMails extends BaseObject implements Persistent
{
    ...
    public function getFinishDt($format = 'Y-m-d H:i:s')
    {
        ...
        if ($this->finish_dt === '0000-00-00 00:00:00') {
            // while technically this is not a default value of null,
            // this seems to be closest in meaning.
            return null;
        }
    ...
    /**
     * Sets the value of the [result] column.
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->result = ($row[$startcol + 15] !== null) ? (boolean) $row[$startcol + 15] : null;
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`finish_dt`':
                        ...
                        break;
                    case '`result`':
                        $stmt->bindValue($identifier, (int) $this->result, PDO::PARAM_INT);
                        break;
                    case '`send_date`':
