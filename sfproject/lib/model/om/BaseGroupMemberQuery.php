 ...
 * @method GroupMemberQuery orderByUserId($order = Criteria::ASC) Order by the user_id column
 ...
 * @method GroupMemberQuery groupByUserId() Group by the user_id column
 ...
 *
 * @method GroupMemberQuery leftJoinUser($relationAlias = null) Adds a LEFT JOIN clause to the query using the User relation
 * @method GroupMemberQuery rightJoinUser($relationAlias = null) Adds a RIGHT JOIN clause to the query using the User relation
 * @method GroupMemberQuery innerJoinUser($relationAlias = null) Adds a INNER JOIN clause to the query using the User relation
 *
 ...
 * @method GroupMember findOneByUserId(int $user_id) Return the first GroupMember filtered by the user_id column
 ...
 * @method array findByUserId(int $user_id) Return GroupMember objects filtered by the user_id column
...
abstract class BaseGroupMemberQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT "id", "is_deleted", "updated_at", "deleted_at", "created_at", "user_id", "group_id", "auth_level_status_id" FROM "group_member" WHERE "id" = :p0';
        try {
    ...
    public function filterByUserId($userId = null, $comparison = null)
    {
        if (is_array($userId)) {
            $useMinMax = false;
            if (isset($userId['min'])) {
                $this->addUsingAlias(GroupMemberPeer::USER_ID, $userId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($userId['max'])) {
                $this->addUsingAlias(GroupMemberPeer::USER_ID, $userId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(GroupMemberPeer::USER_ID, $userId, $comparison);
    }
    ...
    public function filterByUser($user, $comparison = null)
    {
        if ($user instanceof User) {
            return $this
                ->addUsingAlias(GroupMemberPeer::USER_ID, $user->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(GroupMemberPeer::USER_ID, $user->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
